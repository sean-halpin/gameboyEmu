Feature: OpCodeSkeletonGenerator
	In order to generate opCode skeletons
	As an emulation noob
	I want to create switch cases with as much info about the opcode as possible

Scenario: Generate Opcode Cases
	Given a table of opcode details
		| Mneumonic   | Bytes | Cycles | Flags   |
		| NOP         | 1     | 4      | - - - - |
		| LD BC,d16   | 3     | 12     | - - - - |
		| LD (BC),A   | 1     | 8      | - - - - |
		| INC BC      | 1     | 8      | - - - - |
